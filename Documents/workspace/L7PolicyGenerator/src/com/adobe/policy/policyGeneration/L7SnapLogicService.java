...
public class L7SnapLogicService {
	...
	private  L7SnaplogicToken l7SnaplogicToken = null;
	private L7EncodeDecode l7EncodeDecode = null;
	...
	public L7SnaplogicToken getL7SnaplogicToken() {
		return l7SnaplogicToken;
	}

	public void setL7SnaplogicToken(L7SnaplogicToken l7SnaplogicToken) {
		this.l7SnaplogicToken = l7SnaplogicToken;
	}

	public L7EncodeDecode getL7EncodeDecode() {
		return l7EncodeDecode;
	}

	public void setL7EncodeDecode(L7EncodeDecode l7EncodeDecode) {
		this.l7EncodeDecode = l7EncodeDecode;
	}
